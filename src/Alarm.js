...
$(document).ready(function(){
    ...
    var updateClock = function() 
    {
        ...
        if(time==alarm){//if now is time to alarm
            image = "/Users/blackcatecho/Projects/Web-Alarm-clock/ext/IMG_8467.jpeg"; //change pic
            $("#logo").text("Now is time!");//change text to remind now is time
        }
        else if (hour < noon) //check if it's morning
            {
                image= "/Users/blackcatecho/Projects/Web-Alarm-clock/ext/IMG_7464.jpeg"; //morning pic
            ...
            {
                image = "/Users/blackcatecho/Projects/Web-Alarm-clock/ext/IMG_5056.jpeg"; //evening pic
            ...
            {
                image = "/Users/blackcatecho/Projects/ext/Web-Alarm-clock/IMG_5057.jpeg";
